...
// Illustrate bit flags and fast character type functions (cctype clones)
...
#define  ISDIGIT  0x04
#define  ISALNUM  (ISALPHA|ISDIGIT) // bit masks
#define  ISCTL    0x08
#define  ISGRAPH  0x10
...
#define MAX 128         // largest ASCII values + 1 (asymmetric range)
...
static const char _ct[MAX] =
{
    ...
    ISGRAPH|ISDIGIT, ISGRAPH|ISDIGIT,                           /* 54-55 */
...
// with the library's identifiers because Quincy and some other IDEs
// automatically #include the standard C library headers if you don't do it
int IsAlnum( int c )
{
...
int main()
{
    ...
    cout << "Enter ASCII code for character (0-127), out of range to stop: "
         << flush;
    cin  >> ch;
    while( ch >= MIN && ch < MAX ) // loop until illegal ASCII code entered
    {
